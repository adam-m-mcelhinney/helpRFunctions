#' Provides a list containing the data.frame columns that are of a given type. This can be useful for functions that only support a given type.
#' 
#' 
#' @param df The data.frame you wish to have a list of the types for.
#' @return A list with names corresponding to the data type, and entries corresponding to the variable names that are of that type.
#' @examples 
